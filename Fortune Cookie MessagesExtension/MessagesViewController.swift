...
class MessagesViewController: MSMessagesAppViewController {
    ...
    let quotes = [
        ...
        "A person is never too old to learn. (2)",
        ...
        "If your desires are not too extravagant they will be granted. (2)",
    ...
    override func viewDidLoad() {
        ...
        // Set the initial quote on the button
        updateQuoteButton()
    }
    
    @IBAction func sendQuoteTapped(_ sender: UIButton) {
        let selectedQuote = quoteButton.title(for: .normal) ?? ""
        
        // Create an MSMessage with the selected quote
        let layout = MSMessageTemplateLayout()
        layout.caption = selectedQuote
        let message = MSMessage(session: MSSession())
        message.layout = layout
        
        // Insert the message into the current conversation
        ...
        // Generate and set a new quote on the button
        updateQuoteButton()
    }
    
    func updateQuoteButton() {
        let newQuote = generateRandomQuote()
        quoteButton.setTitle(newQuote, for: .normal)
    }
    
    @IBAction func refreshQuoteTapped(_ sender: UIButton) {
        updateQuoteButton()
    }
}
